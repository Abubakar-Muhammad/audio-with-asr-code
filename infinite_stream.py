...
def handle_keyboard_input(queue):
    def on_press(key):
        if key == keyboard.Key.enter:
            queue.put("quit", block=False)
...
class ResumableMicrophoneStream:
    ...
    def __init__(
        ...
        listener = handle_keyboard_input(self.queue)
...
def main() -> None:
    ...
    # listener = handle_keyboard_input(queue)
    ...
    with mic_manager as stream:
        while not stream.closed:    
            ...
            rep = listen_print_loop(responses, stream)
